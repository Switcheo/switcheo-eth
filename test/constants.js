...
const REASON_CODES = {
    REASON_DEPOSIT: 0x01,
    REASON_WITHDRAW: 0x09,
    REASON_WITHDRAW_FEE_GIVE: 0x14,
    REASON_WITHDRAW_FEE_RECEIVE: 0x15,
    REASON_CANCEL: 0x08,
    REASON_CANCEL_FEE_GIVE: 0x12,
    REASON_CANCEL_FEE_RECEIVE: 0x13,
    REASON_SWAP_GIVE: 0x30,
    REASON_SWAP_RECEIVE: 0x35,
    REASON_SWAP_FEE_GIVE: 0x36,
    REASON_SWAP_FEE_RECEIVE: 0x37,
    REASON_SWAP_CANCEL_RECEIVE: 0x38,
    REASON_SWAP_CANCEL_FEE_RECEIVE: 0x3B,
    REASON_SWAP_CANCEL_FEE_REFUND: 0x3D
}
